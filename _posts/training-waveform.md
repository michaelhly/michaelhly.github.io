...
---
The code that trains a large language model fits in a four-line loop. When we run that loop on 100k GPUs, one of those lines becomes the reason regulators now treat data centers like power plants.
