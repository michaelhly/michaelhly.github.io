...
## What About Coherent?
Nvidia ran the same playbook on Coherent that morning and paid a very different price, about 7 times revenue against the 22 times it paid for Lumentum, a company with less than half of Coherent's sales. Part of the discount is the depth chart. Lumentum is expected to supply the high-power lasers for Nvidia's first CPO switches alone, with Coherent entering as a second source in late 2026. Run the same arithmetic backward and the difference is the job each price assigns. Lumentum's price needs the market to grow and its share to grow on top of it. Coherent's price needs a seat held, roughly the share it already has in a market everyone expects. Two bets wearing the same announcement.

![What Nvidia's Price Asks of Coherent](/assets/demystifying-semivc-four/implied-valuation-ramp-coherent.svg)

One more difference runs in the retail investor's favor. Nvidia bought Coherent in plain common stock, the same instrument you would buy, and the stake sits in its 13F filings for anyone to track. The Lumentum preferred never appears there until it converts. You still do not get the purchase commitment, but at least you and Nvidia are holding the same season tickets.

The fiscal year Coherent just closed shows why the seat is not free. Revenue grew 22.5%, but free cash flow finished roughly a billion dollars in the hole, and a $2 billion equity raise took diluted shares from 155.5 million to 202.2 million. Non-GAAP earnings rose 83%. Per share, they rose 74%.

Could we be wrong? Of course. Every assumption above lives in [a spreadsheet you can download and break](/assets/demystifying-semivc-four/lumentum-model.xlsx). If you do not like our margin, our discount rate, or our market share, change them and see what price falls out. We would rather be transparently wrong than opaquely right.
