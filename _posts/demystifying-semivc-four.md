...
The market is not waiting for the handoff. Experts describe [CPO for scale-up as not a matter of if and why, but when and how](https://newsletter.semianalysis.com/p/co-packaged-optics-cpo-book-scaling), and the prices agree. Nvidia paid $695.31 a share for its Lumentum stake in March, pricing the company at roughly $67 billion fully diluted on about $3 billion of revenue, and the stock has traded well above that since. Investors should notice that the most informed buyer in the room is not paying for a promising rookie. The sticker price far exceeds what the Chiefs paid for Mahomes, and Nvidia's price assumes the dynasty is already happening. It is worth doing that arithmetic out loud ...
