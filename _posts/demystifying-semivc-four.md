...
When AI models outgrew the 8-GPU server, Nvidia followed the old adage to *use copper where you can, optics where you must*. The GB200 packed all 72 GPUs and their switches into a single liquid-cooled rack, keeping every link inside copper's two-meter reach. Here were the tradeoffs:
